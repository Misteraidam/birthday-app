...
export default function NeonGlow({ formData }) {
    ...
    return (
        <div className="min-h-screen bg-[#020202] text-[#00FFFF] font-mono selection:bg-cyan-500 selection:text-black relative overflow-x-hidden">
            <AnimatePresence mode="wait">
                {!introComplete && (
                    <NeonIntro key="intro" onComplete={() => setIntroComplete(true)} recipientName={recipientName} />
                )}
            </AnimatePresence>
                ...
                {introComplete && (
                    ...
                    >
                        ...
                        <div className="fixed inset-0 pointer-events-none opacity-20" style={{
                            backgroundImage: `linear-gradient(#00FFFF11 1px, transparent 1px), linear-gradient(90deg, #00FFFF11 1px, transparent 1px)`,
                        ...
                        <header className="relative z-10 pt-32 pb-40 px-6 text-center border-b border-cyan-500/20">
                            <motion.div
                                ...
                                className="mb-12"
                            >
                                <Zap size={48} className="mx-auto text-[#00FFFF]" style={{ filter: 'drop-shadow(0 0 20px #00FFFF)' }} />
                            </motion.div>
                            {recipientName && (
                                <motion.h1
                        ...
                        {formData.secretMessage && (
                            <footer className="relative z-10 py-60 px-6 text-center border-t border-cyan-500/20 bg-gradient-to-t from-cyan-900/10 to-transparent">
                                <Radio size={40} className="mx-auto mb-10 text-fuchsia-500 shadow-fuchsia-500/50" />
...
function NeonIntro({ onComplete, recipientName }) {
    useEffect(() => {
        ...
        >
            ...
            <div className="relative z-10 flex flex-col items-center">
                <motion.div
                    ...
                    className="mb-8 p-6 rounded-full border border-[#00FFFF] shadow-[0_0_50px_#00FFFF]"
                >
                    <Zap size={64} className="text-[#00FFFF]" />
                </motion.div>
                ...
                {recipientName && (
                    ...
                    >
                        <div className="text-[#00FFFF]/50 text-xs tracking-[0.5em] mb-4">INITIALIZING NEURAL LINK...</div>
                        <h1 className="text-6xl md:text-8xl font-black text-transparent bg-clip-text bg-gradient-to-r from-[#00FFFF] to-[#FF00FF] uppercase tracking-tighter filter drop-shadow-[0_0_10px_rgba(0,255,255,0.5)]">
                            {recipientName}
                        </h1>
                    </motion.div>
                )}
...
function NeonChapter({ chapter, index }) {
    ...
    return (
        ...
        >
            {/* Visual Visor */}
            <div className="flex-1 w-full bg-black/40 border border-cyan-500/30 rounded-lg p-1.5 shadow-[0_0_50px_rgba(0,255,255,0.1)] group">
            ...
            <div className={`flex-1 flex flex-col justify-center ${isEven ? 'text-left' : 'text-right md:text-left'}`}>
                <div className="flex items-center gap-4 mb-8">
                    <span className="text-[10px] font-black uppercase tracking-[0.5em] text-cyan-400">MEMORY_NODE_{String(index + 1).padStart(2, '0')}</span>
                ...
                {chapter.voiceNote && (
                    <div className="inline-flex items-center gap-4 p-4 border border-fuchsia-500/50 bg-fuchsia-500/5 text-fuchsia-400">
