...
const HERO_ROSE_BG = "https://images.unsplash.com/photo-1548504769-900b700122e1?q=80&w=2000&auto=format&fit=crop";
...
export default function LandingPage({ onCreateNew, onViewStory, onOpenLegal }) {
    ...
    return (
        <div className="min-h-screen text-white relative font-sans">
            {/* Ultra-Reliable Background Layer */}
            <div
                className="fixed inset-0 pointer-events-none z-0"
                style={{
                    backgroundImage: `url(https://images.pexels.com/photos/1037992/pexels-photo-1037992.jpeg?auto=compress&cs=tinysrgb&w=1600)`,
                    backgroundSize: 'cover',
                    backgroundPosition: 'center',
                    backgroundColor: 'black',
                    filter: 'brightness(0.3) contrast(1.2)' // Directly darkening the image pixels
                }}
            >
                {/* Pure Dark Mode Blend Layer */}
                <div className="absolute inset-0 bg-black/30 mix-blend-multiply" />
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,transparent_0%,#000_90%)]" /> {/* Deep shadow frame */}
            </div>
